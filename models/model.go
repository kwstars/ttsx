...
func init(){
	...
	//注册表
	orm.RegisterModel(new(User),new(OrderInfo),new(OrderGoods),new(Receiver),new(GoodsSKU),new(Goods),new(IndexTypeGoodsBanner),new(IndexGoodsBanner),new(GoodsType),new(GoodsImage),new(IndexPromotionBanner))
	//跑起来
